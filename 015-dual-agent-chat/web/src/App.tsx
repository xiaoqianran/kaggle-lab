  ...
  return (
    <div className="app">
      ...
      <p className="footer-note">
        实验目录 <code>015-dual-agent-chat</code> · CLI:{" "}
        <code>python main.py 015 run</code> ·{" "}
        <a href="https://github.com/xiaoqianran/kaggle-lab/tree/main/015-dual-agent-chat">源码</a>
      </p>
    </div>
  );
}
