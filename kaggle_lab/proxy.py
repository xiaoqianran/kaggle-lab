...
from kaggle_lab.paths import ENV_MODEL_PROXY, REPO_ROOT

ROOT = REPO_ROOT
ENV_FILE = ENV_MODEL_PROXY
...
def print_usage(
    usage, stream=None, *, experiment: str | None = None, model: str | None = None
) -> None:
    ...
    if experiment and model:
        try:
            from kaggle_lab.usage import log_from_openai_usage
