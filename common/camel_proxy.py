...
# Prefer flash-class models to stretch Daily $10
DEFAULT_CAMEL_MODEL = DEFAULT_MODEL  # google/gemini-3-flash-preview
...
def extract_text(response: Any) -> str:
    ...
    if msgs:
        ...
        if parts:
            return "\n".join(parts)
    # RolePlaying returns (assistant_response, user_response)
